...
public final class EmergenciasOperativas extends Idiomas implements Sonidos {
    ...
    private final ConexionBaseDatosNoSQL cn;
    ...
    private void initComponents() {
        ...
        imagen.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Desktop\\GESTION_BD Final\\ProyectoFinalBomberos\\src\\main\\resources\\imagenes\\fondooperativas.jpg")); // NOI18N
    ...
    private void unionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unionActionPerformed
        ...
        } else
        {
            ...
            cn.modificarCasoUsuario(cn.devolverID_Caso(cn.devolverNombreCaso(cn.devolverIDCaso(idiomaElegido))), nombreUsuario);
            cn.modificarCaso(cn.devolverID_Usuario(nombreUsuario), cn.devolverNombreCaso(cn.devolverIDCaso(idiomaElegido)));
            cn.modificarCasoEnCurso(cn.devolverNombreCaso(cn.devolverIDCaso(idiomaElegido)), idiomaElegido);
