...
import aplicacion.BomberoNormal;
 ...
 * @author ShibaXpath
 */
public final class VinculoBombero extends BomberoNormal implements Sonidos {
    /**
     * Creates new form InicioApp
     */
    public VinculoBombero() {
        initComponents();
    ...
    private void japonesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_japonesActionPerformed
        ...
        if (super.getRango().equals("Bombero"))
        {
            super.setRango("消防士");
        }
    ...
    private void españolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_españolActionPerformed
        ...
        if (super.getRango().equals("消防士"))
        {
            super.setRango("Bombero");
        }
        campoMensaje.setText(super.devolverDescripcion());
