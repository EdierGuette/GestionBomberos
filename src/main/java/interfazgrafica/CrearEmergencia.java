...
public final class CrearEmergencia extends Idiomas implements Sonidos {
    ...
    private void initComponents() {
        ...
        imagen.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Desktop\\GESTION_BD Final\\ProyectoFinalBomberos\\src\\main\\resources\\imagenes\\fondoCrear.jpg")); // NOI18N
            ...
            if (cn.comprobarCaso(nombreCaso.getText())) {
                ...
                if (nombreCaso.getText().length() == 0 || nombreCaso.getText().length() > 20) {
                    ...
                    if (valor == JOptionPane.YES_OPTION) {
                        ...
                        cn.insertarEmergencia(nombreCaso.getText(), nivel, tipos.getSelectedItem().toString(), campoMensaje.getText(), nombreUsuario, estado, "ESP");
        ...
        if (seleccionar.isSelected() && cn.devolverCasoUsuario(nombreUsuario)) {
            ...
            if (cn.comprobarCaso(nombreCaso.getText())) {
                ...
                if (nombreCaso.getText().length() == 0 || nombreCaso.getText().length() > 20) {
                    ...
                    if (valor == JOptionPane.YES_OPTION) {
                        // Inserta la emergencia en la base de datos con los valores proporcionados
                        cn.insertarEmergencia(nombreCaso.getText(), nivel, tipos.getSelectedItem().toString(), campoMensaje.getText(), nombreUsuario, estado, "JP");
